...
Antigravity gate and a failed Codex run whose output already carries blocking
findings (exit 2, not 3). A verifiably wrong model (exit 2) claims nothing, since its
