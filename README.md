...
| `/jj` | Drive jujutsu for single-agent work; worktrees for multi-agent |
| `/session-retro` | Propose improvements to your own skills (fires on "thanks", or run manually) |
...
└── claude/
    ...
    │   └── session-retro/      # /session-retro — self-improving skills
