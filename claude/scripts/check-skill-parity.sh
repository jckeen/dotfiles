...
#
# 1. COUNT: README advertises "N slash commands" — assert N matches the actual
#    number of skill directories under claude/skills/. (README said 12 while
#    14 shipped; nothing caught it.)
#
