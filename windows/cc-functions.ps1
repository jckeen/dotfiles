...
#
# Agent-neutral helpers (e.g. `wsl6`) live in `wsl-helpers.ps1` so they can be
# used without implying any Claude/Codex/agent dependency. setup.sh installs
# both files side-by-side and dot-sources each from your $PROFILE.
#
...
# `wsl6` (agent-neutral 3×2 WSL shell grid) lives in `wsl-helpers.ps1`.
