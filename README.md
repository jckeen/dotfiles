...
| `/jj` | Drive jujutsu (jj) version control — single-agent feature work; use worktrees for multi-agent |
...
└── claude/
    ...
    │   ├── jj/                 # /jj — jujutsu version control driver
    │   └── session-retro/      # /session-retro — end-of-session skill improvement
